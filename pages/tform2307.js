...
export default function Form2307() {
  ...
  const [docType, setDocumentType] = useState(null);
          ...
          <div style={previewBoxStyle}>
            ...
            <label>
              <input
                ...
                checked={docType === "serviceinvoice"}
                onChange={radioChange}
              />
              Service Invoice
          </label>

          <input type="file" accept="application/pdf, image/*" onChange={handleFileChange} style={fileInputStyle} id="file-upload" disabled={isUploading || !radioSelected} />
          <div style={fileButtonWrapperStyle}>
            <label htmlFor="file-upload" style={{...fileButtonStyle, ...(!radioSelected ? disabledStyle : {}),}}>Upload Document/Picture</label>
          </div>
        </div>
