import styles from "../styles/expense-receipt.module.css";
...
export default function expense_receipt() {
    const collection = "expense_receipt"
    ...
    const docType = "expense_receipt"

    return(
        <Layout>
        <h1 className="top-h1"> Uploaded Expense Receipt </h1>
